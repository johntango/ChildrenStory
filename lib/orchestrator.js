...
function createOrchestrator(options = {}) {
  ...
  function buildSteps() {
    return [
      { id: "plan", agent: config.orchestrator.name, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null },
      { id: "author-draft", agent: config.author.name, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null },
      {
        id: "psychology-review",
        agent: config.psychologist.name,
        status: "queued",
        startedAt: null,
        endedAt: null,
        error: null,
      ...
      { id: "editor-polish", agent: config.editor.name, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null },
      {
        id: "illustration-meta",
        agent: config.illustrator.name,
        status: "queued",
        startedAt: null,
        endedAt: null,
        error: null,
      ...
      { id: "narration-notes", agent: config.narrator.name, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null },
      { id: "publish", agent: config.orchestrator.name, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null }
    ];
  }
  ...
  function invalidateFromStep(storyId, stepId) {
    return store.updateStory(storyId, (story) => {
      ...
      const nextSteps = story.steps.map((step, i) => {
        if (i >= idx) {
          return { ...step, status: "queued", startedAt: null, endedAt: null, error: null, provider: null, model: null };
        }
        return step;
      });
  ...
  async function executeStep(storyId, stepId, executeFn) {
    ...
    updateStep(storyId, stepId, { status: "running", startedAt: startTime, error: null, provider: null, model: null });
